...
template Model() {
    ...
    component conv2d = Conv2D(28, 28, 1, 4, 3, 1, 10);
    component batch_normalization = BatchNormalization2D(26, 26, 4, 10);
    ...
    component conv2d_1 = Conv2D(13, 13, 4, 8, 3, 2, 10);
    ...
    component dense = Dense(72, 10, 10);
